...
public class CommentService implements CommentUseCase {
     ...
     * 1단계로 댓글을 달려는 레시피가 삭제되지 않은 레시피인지 검증한다. (recipeId, delYn으로 검색)
     * 2단계로 댓글 수정을 요청한 멤버가 댓글의 원작자인지 검증한다. (commentId, memberId, delYn으로 검색)
     ...
     * 1단계로 댓글을 달려는 레시피가 삭제되지 않은 레시피인지 검증한다. (recipeId, delYn으로 검색)
     * 2단계로 댓글 삭제를 요청한 멤버가 댓글의 원작자인지 검증한다. (commentId, memberId, delYn으로 검색)
    ...
    /**
     * [READ] 내가 작성한 댓글이 맞는지 확인하는 메서드
     */
    public boolean checkIsMyComment(Comment comment) {
